...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Supir">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.supirs.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id_supir', name: 'id_supir' },
{ data: 'nama', name: 'nama' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Supir').DataTable(dtOverrideGlobals);
